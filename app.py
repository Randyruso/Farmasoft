#!/usr/bin/env python
import csv
import validar_csv#importo el modulo de validacion de csv
import class_csv#importo el módulo que me genera una lista de objetos con cada registro
    ...
    if formulario.validate_on_submit():
        with open('usuarios') as archivo:
            ...
            while registro:
                ...
                flash('El Usuario y/o la Contraseña no son Valido/s')
...
#_____________________________________________________________________________________________________________________________________
#--------------PRODUCTOS QUE COMPRO UN CLIENTE----------------------------------------------------------------------------------------
